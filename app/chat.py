...
sentiment_mpdel=joblib.load(open('/mount/src/mlmodels/app/sentiment_model.pkl','rb'))
vectorizer = joblib.load("/mount/src/mlmodels/app/tfidf_vectorizer.pkl")
with st.sidebar:
...
if selected=="Sentiment Analysis":
    ...
    if st.button("Predict"):
        loaded_model = joblib.load("/mount/src/mlmodels/app/sentiment_model.pkl")
        vectorizer = joblib.load("/mount/src/mlmodels/app/tfidf_vectorizer.pkl")
    ...
    if predict:
        loaded_model = joblib.load("/mount/src/mlmodels/app/sleep.pkl")
