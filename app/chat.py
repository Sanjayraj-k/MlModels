...
sentiment_mpdel=joblib.load(open('MLModels\app\chat.py','rb'))
vectorizer = joblib.load("MLModels\app\tfidf_vectorizer.pkl")
with st.sidebar:
...
if selected=="Sentiment Analysis":
    ...
    if st.button("Predict"):
        loaded_model = joblib.load("MLModels\app\chat.py")
        vectorizer = joblib.load("MLModels\app\tfidf_vectorizer.pkl")
    ...
    if predict:
        loaded_model = joblib.load("MLModels\app\sleep.pkl")
